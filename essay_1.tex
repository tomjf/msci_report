...
\textsc{\Large MSci. Report}\\[0.5cm] % Minor heading such as course title
...
\large \textit{A report submitted in fulfilment of the requirements\\ for the degree of MSci. Physics}\\[0.3cm] % University requirement text
\textit{in the}\\[0.4cm]
